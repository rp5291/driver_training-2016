...
public class Robot extends IterativeRobot {
    ...
    public void teleopPeriodic() {
   	 ...
   	 SmartDashboard.putString("Gyro Angle", "" + angleInt);
   	 SmartDashboard.putString("Driver ", "" + OI.joystickRight.getPOV());
   	 SmartDashboard.putString("Driver Mode000 Chooser", "" + OI.joystickRight.getPOV(0));

   	  SmartDashboard.putString("Driver sdasdaMode Choose",oi.currentDriveMode);
   	 // +OI.joystickright.getTop());
